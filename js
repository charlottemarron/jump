...
function init() {
	...
	function gameOver() {
		...
		if(player.y > height/2 && flag === 0) {
			...
			tweet.href='https://twitter.com/share?url=http://is.gd/Htgf5C&text=I just scored ' +score+ ' points in the HTML5 Milo Jump game!&count=horiztonal&via=cssdeck&related=solitarydesigns';
		
			var facebook = document.getElementById("fbBtn");
			facebook.href='https://facebook.com/sharer.php?s=100&p[url]=http://cssdeck.com/labs/html5-milo-jump-game&p[title]=I just scored ' +score+ ' points in the HTML5 Milo Jump game!&p[summary]=Can you beat me?';
